...
<div class="page-header">
    <h3 class="fw-bold text-white">
        CATALOGUE <span style="color: var(--accent-green)">STOK</span>
    </h3>
    <p class="text-muted small">
        Kelola data inventaris Anda dengan tampilan gelap yang nyaman.
    </p>
</div>
    ...
    <div class="card">
        <div class="p-4 d-flex justify-content-between align-items-center" style="border-bottom: 1px solid var(--border-color)">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('landing') }}" class="btn btn-action" title="Landing">
                ...
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button type="submit" class="btn btn-action text-danger" title="Logout">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <form id="delete-form-{{ $product->id }}" action="{{ route('products.destroy', $product->id) }}" method="POST">
                                    <a href="{{ route('products.show', $product->id) }}" class="btn btn-action" title="View">

...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    <div class="container">
        <a class="navbar-brand fw-bold" href="{{ route('landing') }}">
            Gows<span style="color: var(--accent)">Auto</span>
        </a>
...
<section class="hero-section">
    <div class="container">
        <h1 class="display-4 fw-bold mb-3">
            Koleksi <span style="color: var(--accent)">Terbaik</span> Kami
        </h1>
        <p class="text-muted">
            Temukan produk impian Anda dengan harga dan kualitas terbaik di kelasnya.
        </p>
    </div>
</section>
                ...
                <div class="card product-card">
                    <div class="img-container">
                        <img
                            ...
                            onerror="this.src='https://placehold.co/600x400/111/00d1b2?text=Image+Not+Found'"
                            alt="{{ $product->title }}"
                        >
                    </div>

                    <div class="card-body p-4 text-center">
                        <span class="badge-stock mb-2 d-inline-block">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title fw-bold">
                                Detail <span style="color: var(--accent)">Unit</span>
                            </h5>
                        ...
                        <div class="modal-body p-4">
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <img
                                        src="{{ asset('storage/products/'.$product->image) }}"
                                        class="img-fluid rounded-4 border border-secondary shadow"
                                        onerror="this.src='https://placehold.co/600x400/111/00d1b2?text=Image+Not+Found'"
                                        alt="{{ $product->title }}"
                                    >
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-4">
                                        <h6 class="text-white fw-bold">
                                            <i class="fa-solid fa-align-left me-2" style="color: var(--accent)"></i>
                                            Deskripsi
                                        </h6>
                                    ...
                                    <div class="p-3 rounded-3 mb-4" style="background: rgba(255,255,255,0.05);">
                                        ...
                                        <h3 class="fw-bold mb-0" style="color: var(--accent)">
                                            Rp {{ number_format($product->price, 0, ',', '.') }}
                                        </h3>
                                    ...
                                    <a
                                        href="https://wa.me/6283131593799?text=Halo%20GowsAuto,%20saya%20ingin%20bertanya%20tentang%20{{ urlencode($product->title) }}"
                                        target="_blank"
                                        class="btn btn-buy py-3"
                                    >
